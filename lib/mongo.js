...
export const getMongoClient = async () => {
  try {
    ...
    if (
      ...
      logger.warn('MongoDB topology error, creating fresh connection...');
      ...
      try {
        ...
        logger.error('Failed to create fresh MongoDB connection:', retryErr.message);
        throw retryErr;
      }
    }
...
export const getDatabase = async (databaseName) => {
  try {
    ...
    logger.error('Error getting database:', error.message);
    throw error;
  }
};
